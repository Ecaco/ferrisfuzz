...
use super::*;
    ...
    #[test] 
    fn test_jaro_martha() {
        let result = jaro_winkler_classic("MARTHA", "MARHTA", Some(0.0), None, None).unwrap();
    ...
    fn test_jaro_winkler_martha() {
        let result = jaro_winkler_classic("MARTHA", "MARHTA", None, None, None).unwrap();
        assert!((result - 0.961).abs() < 0.001, "got {}", result);
    }

    #[test]
    fn test_empty_string_2() {
        let result = jaro_winkler_classic("MARTHA", "",Some(0.0), None, None);
    ...
    fn test_empty_strings() {
        let result = jaro_winkler_classic("", "", Some(0.0), None, None);
        assert_eq!(result, Ok(1.0))
    }

    #[test]
    fn test_upper_p() {
        let result = jaro_winkler_classic("MARTHA", "MARTER", Some(0.5), None, None);
    ...
    fn test_crate_trace_case() {
        let result = jaro_winkler_classic("CRATE", "trace", Some(0.0), None , Some(true)).unwrap();
        assert!((result - 0.733).abs() < 0.001, "got {}", result);
    }

    #[test]
    fn test_char_limit() {
        let result = jaro_winkler_classic("MARTHA", "MARHTA", Some(0.0), Some(5), None);
